        ...
        >
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-300 leading-relaxed mb-8">
              We provide the tools, the chemistry, and 30 years of documented IP. You provide the venue. All courses are <strong>$250 CAD</strong> — workshops are seasonal and fill quickly.
            </p>
