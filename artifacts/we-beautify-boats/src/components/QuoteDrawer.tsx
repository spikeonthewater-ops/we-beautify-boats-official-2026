...
const SERVICE_DATA: Record<QuoteCategory, CategoryData> = {
  ...
  workshops: {
    ...
    items: [
      { level: "WF-PRO", name: "The Marina Pro-Series",          desc: "For marina staff and professional crews. Covers efficiency, workflow optimization, crew leadership, and scaling service across multiple vessels.", prices: [100,100,100,100,100,100,100], features: ["Staff & crew format","Workflow & leadership focus","Certificate of Practical Completion"] },
      { level: "WF-OWN", name: "Yacht Club Owner's Day",         desc: "For private boat owners. Practical DIY skills, tool safety, seasonal maintenance routines — take the knowledge back to your own vessel.", prices: [100,100,100,100,100,100,100], features: ["Private owner format","DIY skills & tool safety","Certificate of Practical Completion"] },
      { level: "WF-ADV", name: "The Restoration Masterclass",    desc: "For advanced technicians. Wet sanding, spot repairs, Spike's PT surface protection application, brightwork, and vinyl restoration at the highest level.", prices: [100,100,100,100,100,100,100], features: ["Advanced technician format","Wet sand, restore & protect","Certificate of Practical Completion"] },
      { level: "W100",   name: "100 Series: Fundamentals",       desc: "Entry-level hybrid course — online theory plus on-the-water practical. Surface reading, compound basics, tool safety. Certificate of Practical Completion.", prices: [100,100,100,100,100,100,100], features: ["Hybrid format","Entry-level curriculum","Certificate of Practical Completion"] },
      { level: "W200",   name: "200 Series: Advanced Theory",    desc: "Comprehensive online theory platform (200) with optional on-the-water practical (201). Compound chemistry, oxidation dynamics, gelcoat substrates, business of detailing.", prices: [100,100,100,100,100,100,100], features: ["Online theory platform","Optional practical add-on","Certificate of Theoretical Completion"] },
      { level: "W300",   name: "300 Series: Advanced Practical", desc: "Hands-on only. Buffing mastery, restoration, vinyl recoloring, brightwork, heavy fallout wash, Level 4 interior mold remediation. Spike's PT protection included.", prices: [100,100,100,100,100,100,100], features: ["Hands-on practical only","Advanced & crew management modules","Certificate of Practical Completion (300)"] },
    ],
  },
  visitBundles: {
    title: "Visit Bundles",
